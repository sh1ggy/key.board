	...
	return (
		<div className="flex flex-col w-96 h-64 p-6 justify-items-end bg-[#5D616C] rounded-lg mt-24 mx-6">
			<div className='flex'>
				...
				<code className="mb-3 text-sm font-bold tracking-tight ml-auto p-1 px-3 rounded-lg bg-[#8F95A0] text-gray-900 dark:text-white"><strong>Index: {cardIndex}</strong></code>
			</div>
